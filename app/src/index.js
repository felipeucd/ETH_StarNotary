...
const App = {
  ...
  lookUp: async function (){
    ...
    let symb = await symbol().call();
    console.log(starName, contract, symb);
    if (starName.length == 0){
      let message = "Star is not registered/owned! "
      App.setStatus(message, "status");
    }else{
      let message = "Star owned." + " Star ID is: "+id+ ". Its name is: "+starName + ". Contract name is: "+contract + ". Its Symbol is: " +symb;
      App.setStatus(message,"status");
    }
